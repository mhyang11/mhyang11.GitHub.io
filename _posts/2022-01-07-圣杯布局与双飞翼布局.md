...
![image-20220602073116559.png](https://cdn.jsdelivr.net/gh/mhyang11/FigureBed/imgimage-20220602073116559.png)
...
![](https://raw.githubsercontent.com/mhyang11/FigureBed/@main/img/image-20220602073444070.png)
...
![](https://raw.githubsercontent.com/mhyang11/FigureBed/@main/img/image-20220602073626099.png)

再设置position: relative;left: -200px；使其移位到中间盒子的左边，不会遮挡中间盒子，效果如下：

![](https://raw.githubsercontent.com/mhyang11/FigureBed/@main/img/image-20220602074126251.png)

（5）右盒子设定一个-右盒子宽度的margin-left，即margin-left：-200px，并设定相对定位，相对定位的right为-右盒子的宽度。

首先，设置margin-left：-200px可以将右盒子移动到与中间盒子一行的位置，效果如下：

![](https://raw.githubsercontent.com/mhyang11/FigureBed/@main/img/image-20220602074313124.png)

设置相对定位position: relative; right: -200px;后，效果如下：

![](https://raw.githubsercontent.com/mhyang11/FigureBed/@main/img/image-20220602074621658.png)
...
![](https://raw.githubsercontent.com/mhyang11/FigureBed/@main/img/image-20220602131304164.png)
（2）给左边盒子设定-100%的margin-left，即margin-left： -100%时，会将左盒子移动一个父元素的宽度，也就将左边盒子提升到中间盒子的左边起始的位置，效果如下，，即可将左盒子移动到上面左栏应处于的位置；

效果如下：

![image-20220602130959434](https://raw.githubsercontent.com/mhyang11/FigureBed/@main/img/image-20220602130959434.png)

（3）给右盒子设定-右盒子宽度的margin-left，即margin-left:-200px;，即可将右盒子移动到右栏应处于的位置。效果如下：

![image-20220602131429804](https://raw.githubsercontent.com/mhyang11/FigureBed/@main/img/image-20220602131429804.png)
